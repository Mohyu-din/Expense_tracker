...
app.secret_key = "supersecretkey123"   # you can use any random string
...
def delete_expense(id):
    ...
    # Correct way to get the expense by id
    ...
    # Delete the expense
    db.session.delete(expense)  # ❌ you had .remove() which is wrong
    db.session.commit()
